...
<body>
    ...
    <div style="position: fixed; top: 34px; left: 24px; width: 584px; height: 272px;"  >
        ...
        <asp:Label  ID="Label1" class="vzh2" runat="server" Text="These are Your Exsisting Serivces"></asp:Label>
        <br />
        <br />
        <br />
...
<asp:BoundField DataField="Product_ID" HeaderText="Name"/>
<asp:BoundField DataField ="Product_name" HeaderText="FirstName" />
